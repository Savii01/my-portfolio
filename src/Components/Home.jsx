  ...
  return (
    ...
    >
      <div className='flex justify-between items-center animate-fadeInLeft'>
        <div className='flex flex-col gap-5 md:pr-10 lg:pr-20 '>
          <a target='_blank' rel='noreferrer' href='https://github.com/Savii01'>
            <FaIcons.FaGithub className='text-lightBlue hover:text-blueWhite cursor-pointer text-2xl hover:animate-headShake'/>
          </a>
          <a target='_blank' rel='noreferrer' href='https://twitter.com/Savii_01'>
          <FaIcons.FaTwitter className='text-lightBlue hover:text-blueWhite cursor-pointer text-2xl hover:animate-headShake'/>
          </a>
          <a target='_blank' rel='noreferrer' href='https://www.instagram.com/andrewsdesign_/'>
            <FaIcons.FaInstagram className='text-lightBlue hover:text-blueWhite cursor-pointer text-2xl hover:animate-headShake'/>
          </a>
          <a target='_blank' rel='noreferrer' href='https://api.whatsapp.com/send/?phone=2349049152073&text&type=phone_number&app_absent=0'>
            <FaIcons.FaWhatsapp className='text-lightBlue hover:text-blueWhite cursor-pointer text-2xl hover:animate-headShake'/>
          </a>
          <a target='_blank' rel='noreferrer' href='https://www.linkedin.com/in/saviour-andrew1/'>
            <FaIcons.FaLinkedin className='text-lightBlue hover:text-blueWhite cursor-pointer text-2xl hover:animate-headShake'/>
          </a>
          <a target='_blank' rel='noreferrer' href='https://web.facebook.com/anthony.saviour.942/'>
            <FaIcons.FaFacebook className='text-lightBlue hover:text-blueWhite cursor-pointer text-2xl hover:animate-headShake'/>
          </a>
        </div>
         <div className='w-[800px] animate-fadeInRight  md:hidden'>
           <img src={Photo1} alt="photo1" />
        </div>
      </div>
      <div className='flex flex-col gap-2 text-white animate-fadeIn'>
        ...
        <Link to='#contact' smooth className='active:text-lightBlue' >
          <button className='text-darkBlue bg-lightBlue font-medium py-4 px-2 w-[140px] text-center rounded-md mt-5 hover:bg-blue hover:text-white hover:animate-headShake flex gap-2'>Contact Me <FaIcons.FaPaperPlane className=' font-bold text-xl '/></button>
        </Link>
      </div>
